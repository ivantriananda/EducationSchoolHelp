                    ...
                    <table>
                      ...
                      <tbody style="width: 100%;">
                        <?php 
                            include 'koneksi.php';
                            $no = 1;
                            $data = mysqli_query($koneksi,"select * from request Where requestStatus='New'");
                        ...
                        ?>
                          <tr>
                              ...
                              <td>
                                  <a href="OfferSubmit.php?ida=<?php echo $d['requestID'];?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete"></i></a>
                              </td>
                          </tr>
                          <?php 
                            }
