                    ...
                    <table>
                      ...
                      <tbody style="width: 100%;">
                        <?php 
                            include 'koneksi.php';
                            $no = 1;
                            $data = mysqli_query($koneksi,"select * from offer Where offerstatus='PENDING'");
                            while($d = mysqli_fetch_array($data)){
                        ?>
                          <tr>
                              <td><?php echo $no++; ?></td>
                              <td><?php echo $d['offerDate']; ?></td>
                              <td><?php echo $d['offerstatus']; ?></td>
                              <td><?php echo $d['get_ID_Request']; ?></td>
                              <td><?php echo $d['get_ID_User']; ?></td>
                              <td>
                                  <a href="offerViewp.php?ida=<?php echo $d['get_ID_Request'];?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete"></i></a>
                              </td>
                          </tr>
                          <?php 
                            }
